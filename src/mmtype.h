...
struct mm_calibration_cb {
	...
	/**
	 * create_img() - configure a new image be available in gui in specified
	 * slot
	 ...
	 *
	 * Return: pointer to the image buffer to be used for the new image
	 * update
	 */
	void* (* create_img)(void* ptr, const struct mm_imgdesc* des, int slot);

	/**
	 * update_img() - signal that a new image content is available in the
	 * specified slot
	 * @ptr:        user provided pointer @mm_calibration_cb.data
	 ...
	 */
	void (* update_label)(void* ptr, int elt_type, int slot, const
	                      char* label);
	 ...
	 * @slot:       slot of the element of type @elt_type to update
	 * @state:      state to change (MM_CELTST_* with mask of
	 * MM_CELTST_DISABLE and/or MM_CELTST_INVISIBLE)
	 */
	void (* update_state)(void* ptr, int elt_type, int slot, int state);

	/**
	 * update_value() - update value displayed in specified calibration
	 * element
	 * @ptr:        user provided pointer @mm_calibration_cb.data
	 * @elt_type:   element type to update
	 * @slot:       slot of the element of type @elt_type to update
	...
	/**
	 * define_panel() - discard content of previous calibration panel and
	 * setup a new one
	 * @ptr:        user provided pointer @mm_calibration_cb.data
	 * @paneldesc:  description of the new panel
	 */
	void (* define_panel)(void* ptr, const struct
	                      mm_calib_paneldesc* paneldesc);
