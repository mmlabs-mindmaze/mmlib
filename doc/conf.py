# -*- coding: utf-8 -*-
#
# mmlib documentation build configuration file, created by
# sphinx-quickstart on Tue Nov 14 11:46:19 2017.
#
...
latex_documents = [
    (master_doc, 'mmlib.tex', u'mmlib Documentation',
...
man_pages = [
    (master_doc, 'mmlib', u'mmlib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mmlib', u'mmlib Documentation',
     author, 'mmlib', 'One line description of project.',
     'Miscellaneous'),
]
...
kernel_doc_known_attrs = 'LOCAL_SYMBOL MMLIB_API noreturn'
